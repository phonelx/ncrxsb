...
public interface IProjectConfigDao {
	...
	*/
	 ...
	 * @since JDK 1.7
	 */
	List<Project> selectProjectAll(Connection conn) throws SQLException;
	...
	*/
	...
	/**
	  ...
	  * @since JDK 1.7
	*/
	Project selectProjectBySqu(String squ, Connection conn);
	...
	*/
	...
	/**
	  ...
	  * @since JDK 1.7
	*/
	List<Project> selectProjectPageInfoBySearch(PageInfoVo pageVo,
