...
public interface IStentsDao {
	 ...
	 * 
	  ...
	  * @since JDK 1.7
	 */
	public PageInfoVo selectZhbj(PageInfoVo page,String squ,String key)throws SQLException;
	/**
	 * 添加组合部件
	 ...
	 * 
	  ...
	  * @since JDK 1.7
	 */
	public  PageInfoVo selectZhbjXq(PageInfoVo page ,String squ,String key) throws SQLException;
	/**
	 * 
	  * selectSingleZhbj:(获取组合部件的基本信息).
	  * TODO(这里描述方法适用条件/执行流程/使用方法/注意事项).
	  * @author: 唐青
	  * @dateTime: 2018-1-23 下午5:21:36
	  * @return
	  * @throws SQLException List<Map<String,String>>
	  * @since JDK 1.7
	 */
	public List<Map<String,String>> selectSingleZhbj(String squ) throws SQLException;
	 ...
	 * 
	  ...
	  * @since JDK 1.7
	 */
	public PageInfoVo queryBjInfo(PageInfoVo page,String id,String type) throws SQLException;
	...
	/**
	 * 添加组合部件中的部件
	  * addBuJian:(这里用一句话描述这个方法的作用).
	  * TODO(这里描述方法适用条件/执行流程/使用方法/注意事项).
	  * @author: 唐青
	  * @dateTime: 2017-10-30 下午7:51:13
	  * @param zhbjVo
	  * @throws SQLException void
	  * @since JDK 1.7
	 */
