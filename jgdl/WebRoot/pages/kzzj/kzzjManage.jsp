				     	...
				     	<div class="box-content">
								...
								<input type="hidden" name="zjlxsqu" id="zjlxsqu" value=""/>
								  ...
								  <div class="control-group">
									...
									<div class="controls">
										<select name = "szzt" id="szzt">
											<option value="-1">--请选择设置状态--</option>
											<option value="1">吊装</option>
											<option value="2">支装</option>
											<option value="1">悬臂</option>
										</select>
									 <!--  <input class="input-xlarge focused" id="focusedInput" name = "zjmc" type="text" value="" style = "width:213px"> -->
									</div>
								  </div>
								  <div class="control-group">
									<label class="control-label" for="focusedInput">专业码：</label>
									<div class="controls">
										<select name = "zym" id="zym">
											<option value="-1">--请选择专业码--</option>
								  ...
								  <%-- <div class="control-group">
									<label class="control-label" for="focusedInput">力学参数：</label>
									<div class="controls">
									  <div class="input-append"><input class="input-xlarge focused" id="lxcs" name = "lxcs" type="text" value="" style = "width:178px">&nbsp;&nbsp;<span class="add-on">N</span></div>
									</div>
								  </div> --%>
								  <!-- <div class="control-group">
								  ...
								  <div class="control-group">
								   ...
								   <div class="control-group">
									...
									<div class="controls" style="overflow: hidden;">
										...
										<div id="preview">
	    									<img id="imghead" border=0 src="resource/images/1208160.png" style="height:80px;width: 80px" />
										</div>
										
										<div >
											<input class="input-xlarge focused" id="photo" type="file" name="file" onchange="previewImage(this)"
											style = "margin-left: 100px;margin-top: -90px;">
