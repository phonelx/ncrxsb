	...
	<div class="container-fluid">
		...
		<div class="leftSideBar span3">
				<ul style="width:100%;" class="parNav">
					...
					<li class="nav-header hidden-tablet border-bottom">
						<ul class="topnav" id="tree">
							<%-- <c:forEach items="${list}" var="t" varStatus="status">
								<li class="border-bottom"><a href="javascript:void(0);"
									flag="1" id="${t.SQU}" zbm="${t.DMLB}" zhdm="${t.ZHDM}"
									title='${t.LBMC}' isEnd="${t.JD}" onclick="parentload(this)">
										<!--  <i class="icon-darkgray"></i>  --> &nbsp;${t.LBMC}
								</a>
									<ul class="topnav">
