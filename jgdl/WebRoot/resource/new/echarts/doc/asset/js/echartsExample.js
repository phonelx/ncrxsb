...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['resource/new/echarts/doc/example/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
...
if (developMode) {
    ...
    (function () {
        ...
        script.src = pathLevelArr.join('resource/new/echarts/doc/') + 'asset/js/esl/esl.js';
    ...
    require.config({
        paths: {
            echarts: 'resource/new/echarts/doc/example/www/js'
        }
    });
    launchExample();
}
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            'resource/new/echarts/doc/example/theme/' + hash.replace('-en', ''),
            'echarts/chart/line',
            'echarts/chart/bar',
