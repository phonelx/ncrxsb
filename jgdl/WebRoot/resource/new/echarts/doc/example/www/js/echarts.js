...
define('echarts/echarts', [
    ...
    'resource/new/echarts/doc/example/theme/macarons',
    'resource/new/echarts/doc/example/theme/infographic'
], function (require) {
        ...
        setTheme: function (theme) {
            if (theme) {
                if (typeof theme === 'string') {
                    switch (theme) {
                    case 'macarons':
                        theme = require('resource/new/echarts/doc/example/theme/macarons');
                        break;
                    case 'infographic':
                        theme = require('resource/new/echarts/doc/example/theme/infographic');
                        break;
                    default:
                        theme = {};
                    }
...
define('zrender/zrender', [
    ...
    return Whirling;
});define('resource/new/echarts/doc/example/theme/macarons', [], function () {
    var theme = {
        color: [
            '#2ec7c9',
            '#b6a2de',
    ...
    return theme;
});define('resource/new/echarts/doc/example/theme/infographic', [], function () {
    var theme = {
        color: [
            '#C1232B',
            '#B5C334',
