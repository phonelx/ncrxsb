...
public interface IProjectChildService {
	...
	Project_Child getChildProjectBySqu(String squ) throws SQLException;
	...
	*/
	 ...
	 * @throws SQLException 
	  * @since JDK 1.7
	*/
	Integer countChildProjectByProjectSqu(String projectSqu) throws SQLException;
	 ...
	 * @throws SQLException 
	  * @since JDK 1.7
	*/
	String delChildProjectBySqu(String squ) throws SQLException;
	...
	*/
	...
	/**
	 * 
	  * getChildInfoBySqu:(根据子单位工程的squ查询子单位工程信息).
	  * TODO(这里描述方法适用条件/执行流程/使用方法/注意事项).
	  * @author: 唐青
	  * @dateTime: 2018-6-27 下午6:52:05
	  * @param childsqu
	  * @param conn
	  * @return
	  * @throws SQLException Project_Child
	  * @since JDK 1.7
	 */
	Project_Child getChildInfoBySqu(String childsqu ,Connection conn)throws SQLException;
}
