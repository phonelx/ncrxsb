...
public interface IKzzjMxpzService {
	...
	public PageInfoVo searchKzzjBjList(PageInfoVo pages,String dxsqu,String searchKey,int op)throws SQLException;
	 ...
	 * 
	  ...
	  * @since JDK 1.7
	 */
	public PageInfoVo selectSeismicStents(PageInfoVo page,String id)throws Exception;
