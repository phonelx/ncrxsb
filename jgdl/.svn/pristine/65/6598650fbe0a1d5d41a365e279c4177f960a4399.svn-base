				...
				<ul style="border: 1px">	
					<li class="nav-header hidden-tablet border-bottom">					
							<span id="span" style="padding-left:10px;">[+] </span>
										<a href="javascript:void(0);" flag="3" id="gd" squ="000000" tier=""  titlezh ="" ssmc="管道类型"  title="" isend="0" 
										onclick="parentloadGd(this)">&nbsp; 管线参数</a>								
								<ul class="topnav">
				...
				<div class="modal-body" style="padding:20px;">
					<table id="sort_table" align="center">
						...
						<tr>								
							<td>理论重量：</td>
							<td>
<!-- 							<span class="right-padding">力学参数：</span><input type="text" id="lxcs" name="lxcs" style="width: 175px"/>&nbsp;&nbsp;<span class="add-on">N</span> -->
								<div class="input-append"><input style="width: 145px" type="text" class="sort_input inputWidth"  id="ZH" name="gdlx.ZH"/>&nbsp;&nbsp;   <span class="add-on">KN/M</span></div>
							</td>
						</tr>
						<tr>								
							<td>类别代码：</td>
	...
	<div class="container">
			...
			<div id="exampleGg" class="modal hide fade in windowBoxLittle" style="display: none;height:270px;">
			
				<input type="hidden" id="rsqu" name="rtype.parSqu" />
				<div class="modal-header">
					<a class="close" data-dismiss="modal">×</a>
					<h3 id="secondTitleGg">新增管线规格</h3>
				</div>
				<div class="modal-body" style="padding:20px;">
					<table id="sort_table" align="center">
						<tr>
							<td>管线规格：</td>
							<td>
								<input type="text" class="sort_input inputWidth" id="XHGg" name="gdlx.XH"/>
							</td>								
						</tr>
				...
				<div class="bottomBtnBox">
					<a title="确定" href="javaScript:void(0);" class="btn btn-success" id="sortBtnGg" style="margin:14px 0;">
						<i class="icon-ok icon-white"></i> 确定
					</a> 
					<a title="取消" href="javaScript:void(0);" class="btn" data-dismiss="modal" id="closeWin" style="margin:14px;"> 
						<i class="icon-remove"></i> 取消
	...
	<div class="container">
			...
			<div id="exampleCz" class="modal hide fade in windowBoxLittle" style="display: none;height:270px;">
			
				<input type="hidden" id="rsqu" name="rtype.parSqu" />
				<div class="modal-header">
					<a class="close" data-dismiss="modal">×</a>
					<h3 id="secondTitleCz">新增管线材质</h3>
				</div>
				<div class="modal-body" style="padding:20px;">
					<table id="sort_table" align="center">
						<tr>
							<td>管线材质：</td>
							<td>
								<input type="text" class="sort_input inputWidth" id="XHCz" name="gdlx.XH"/>
							</td>								
						</tr>
				...
				<div class="bottomBtnBox">
					<a title="确定" href="javaScript:void(0);" class="btn btn-success" id="sortBtnCz" style="margin:14px 0;">
						<i class="icon-ok icon-white"></i> 确定
					</a> 
					<a title="取消" href="javaScript:void(0);" class="btn" data-dismiss="modal" id="closeWin" style="margin:14px;"> 
						<i class="icon-remove"></i> 取消
	...
	<input type="hidden"  id="gdpd" value="000000">
	<input type="hidden"  id="gdtitle" >
