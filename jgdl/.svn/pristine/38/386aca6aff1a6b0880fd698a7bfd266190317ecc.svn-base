...
$.fn.pagination.defaults={total:1,pageSize:10,pageNumber:1,pageList:[10,20,50,100,200],loading:false,buttons:null,showPageList:true,showRefresh:true,onSelectPage:function(_75,_76){
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"正在加载,请稍候...",frozenColumns:[[{field:"f",width:16,resizable:false}]],columns:[[{field:"name",title:"数据项名",width:100,sortable:true},{field:"value",title:"数据项值",width:100,resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_55f){
return _55f;
}});
})(jQuery);
(function($){
