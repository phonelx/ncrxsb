...
<body onkeydown="keyDown(event);">
   ...
   <div class="container-fluid">
					 ...
					 <div class="row-fluid tooltip-demo" style="margin-left:-5px;">
					     ...
					     <!-- 	/<input type="hidden" name="zhVo.ZBJSQU" id="ZHJSQU"> -->
							...
							<table  class="table table-bordered">
								  		...
								  		<tr>
								  		<td colspan="2">组合部件名称：</td>
								  		<td colspan="2"><input type="text" placeholder="请输入组合部件名称..." id="DXZHMC1" name="zhVo.DXZHMC"   /></td>
								  		</tr>
								  		<tr>
								  		<td colspan="2">支架形式：</td>
								  		<td colspan="2"> <input type="text" placeholder="请输入支架类型..." id="ZJXS1" name="zhVo.ZJXS"  /></td>
								  		</tr>
								  		<tr>
								  		<td colspan="2">管道类型：</td>
								  		<td colspan="2"><input type="hidden" id="hfexample1" name="zhVo.GDLX"  />
								  		...
								  		<tr>
										<td colspan="2">力学参数：</td>
								  		<td colspan="2"><div class="input-append"><input type="text" placeholder="请输入力学参数..." id="LXCS1" name="zhVo.LXCS"  style="width: 175px"/>&nbsp;&nbsp;<span class="add-on">N</span></div></td>						  		
								  		</tr >	
								  		<tr>
	...
	<div class="container" style="width: 900px;height: 700px;">
		<div id="example3" class="modal hide fade in windowBoxBig" style="display: none;width: 900px;height: 680px;left: 720px;    margin-top: -340px;">
			<div class="modal-header">
			...
			<div class="modal-body">
				...
				<div class="select-box1" align="center" style="margin-top:5px;width:718px;margin-left: 70px;height: 490px">					
					<div class="wrap">
						<ul class="first1 ul"></ul>
						<ul class="second1 ul" ></ul>
						<ul class="third1 ul" ></ul>
						<ul class="foure1 ul" ></ul>
						<!-- <ul class="five1" ></ul> -->
					</div>
					<div>
						<table class="table table-striped table-bordered bootstrap-datatable datatable" id="bj_body" >
							
						</table>
						<div id="pageDivbj"></div>
					</div>
					<input type="hidden" id="zhbjsqu"/>
				</div> 
